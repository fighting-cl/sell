    ...
    <transition name="fade">
      <div v-show="detailShow" class="detail">
        ...
        <div class="detail-wrapper clearfix">
          ...
          <!--优惠商品 flex布局 这里用的是三个div，因为如果用span的话，某些安卓浏览器会产生一些问题-->
          <div class="title">
            <div class="line"></div>
          ...
          <!--商家公共区，和优惠区一样的直接复制，也可以做成组件，这里样式都不用写了，因为上面的优惠信息里已经写了-->
          <div class="title">
            <div class="line"></div>
...
@import "../../common/stylus/mixin";
   .header
        ...
        .content
          ...
          .support
            .icon
              ...
              backgrounnd-repeat: no-background-repeat
              &.decrease
                bg-image('decrease_1')
              &.discount
                bg-image('discount_1')
      ...
      .detail
        ...
        backdrop-filter: blur(10px)// 这个是针对苹果的模糊效果
